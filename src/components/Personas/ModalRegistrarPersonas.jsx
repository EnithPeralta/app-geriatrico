...
import { useAcudiente, useAuthStore, useEnfermera, useForm } from '../../hooks';
            ...
            <div className='modal'>
                <div className='modal-content-geriatrico'>
                    ...
                    <form onSubmit={registerSubmit}>
                        ...
                        <input type='text' name='per_documento' value={per_documento || acudienteDocumento} onChange={onInputChange} placeholder='Documento' required />
